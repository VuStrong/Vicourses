            ...
            >
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div
                        ...
                        className="transform overflow-hidden rounded-lg text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none"
                    >
                        {children}
                    </div>
                </div>
